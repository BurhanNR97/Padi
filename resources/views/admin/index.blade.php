        ...
        <div class="col-xl-3 col-xxl-6 col-sm-6">
            <div class="card bg-warning invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num">{{ $jmlPadi }}</h2>
                        <span class="text-white fs-18">Bibit Padi</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-xxl-6 col-sm-6">
            <div class="card bg-success invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num">{{ $jmlKriteria }}</h2>
                        <span class="text-white fs-18">Kriteria</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-xxl-6 col-sm-6">
            <div class="card bg-info invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num">{{ $jmlRekom }}</h2>
                        <span class="text-white fs-18">Hasil Rekomendasi</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-xxl-6 col-sm-6">
            <div class="card bg-secondary invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num">{{ $jmlAkun }}</h2>
                        <span class="text-white fs-18">Akun Admin</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row invoice-card-row">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Grafik Jumlah Rekomendasi Pencarian Petani</h4>
            </div>
            <div class="card-body">
...
<script>
  ...
  new Chart(ctx, {
    type: 'bar',
    data: {
      labels: ['Bioprima', 'Ciherang', 'Inpara 08', 'Inpari 09', 'Mekongga', 'Malaysian Rice', 'Inpago 12', 'Ketonggo', 'Cakrabuana'],
      datasets: [{
        label: 'Jumlah Hasil Rekomendasi',
        data: [{{$bioprima}}, {{$ciherang}}, {{$inpara08}}, {{$inpari09}}, {{$mekongga}}, {{$mr}}, {{$inpago12}}, {{$ketonggo}}, {{$cakrabuana}}],
        borderWidth: 1
      }]
    },
    options: {
